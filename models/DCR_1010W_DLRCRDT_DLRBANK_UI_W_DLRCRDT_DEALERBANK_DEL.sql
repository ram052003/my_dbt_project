/* Transformation Name ==>W_DLRCRDT_DEALERBANK_DEL ,Transformation Type ==>Target */
...
w_dlrcrdt_bank_delOut as (
	
Select 
I_BUS_4 as I_BUS,
T_STMP_UPD_4 as T_STMP_UPD,
D_EFFCTV_STRT_4 as D_EFFCTV_STRT,
'9999-12-31' as D_EFFCTV_END 
From DSstgVar_XFR_DLRBANK_1Out as DSstgVar_XFR_DLRBANK_1Out Where I_BUS_4 IS NULL = 0 AND StgOldBus  !=  StgBus)
...
From w_dlrcrdt_bank_delOut as w_dlrcrdt_bank_delOut