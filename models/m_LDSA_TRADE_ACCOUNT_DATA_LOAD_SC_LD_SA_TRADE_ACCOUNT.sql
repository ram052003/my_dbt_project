...
DSR_EXP_TRIMOut as (
    ...
    from SQ_SC_LCHSA_ETD_TradeAccount_YYYYmmdd_YYYYmmddHH24missOut
),
...
EXP_PASS_THROUGHOut as (
    ...
    left join (
        ...
        from (
            ...
            from (
                select DIMENSION_KEY, NAME, EFFECTIVE_DATE,
                       nvl(EXPIRATION_DATE, to_date('31-DEC-2099','DD-MON-YYYY')) as EXPIRATION_DATE,
...
EXP_LDSA_VALIDATION_CHECKER_COLLATERAL_ACCOUNTOut as (
    ...
    from DSR_EXP_LDSA_VALIDATION_CHECKER_COLLATERAL_ACCOUNTOut
    left join (
...
EXP_LDSA_VALIDATION_CHECKER_CMFOut as (
    select
        ...
        v_ERROR_MESSAGE_DATE || v_ERROR_MESSAGE_STR || v_ERROR_MESSAGE_NUM as o_COMBINED_ERROR_MESSAGE,
        case when v_VALIDATION_PASS_FAIL = 'F' then 1 else 0 end as o_ERROR_SEVERITY
    from DSR_EXP_LDSA_VALIDATION_CHECKER_CMFOut
    left join (
        select ACTIVE_Y_N_STR_VL, STRING_VALUE2
        from (
            select ACTIVE_Y_N_STR_VL, STRING_VALUE2,
...
EXP_LDSA_VALIDATION_CHECKER_SEGREGATION_TYPEOut as (
    select
        ...
        v_ERROR_MESSAGE_DATE || v_ERROR_MESSAGE_STR || v_ERROR_MESSAGE_NUM as o_COMBINED_ERROR_MESSAGE,
        case when v_VALIDATION_PASS_FAIL = 'F' then 1 else 0 end as o_ERROR_SEVERITY
    from DSR_EXP_LDSA_VALIDATION_CHECKER_SEGREGATION_TYPEOut
    left join (
        select ACTIVE_Y_N_STR_VL, STRING_VALUE2
        from (
            select ACTIVE_Y_N_STR_VL, STRING_VALUE2,
...
EXP_LDSA_VALIDATION_CHECKER_FINANICAL_ACCOUNTOut as (
    select
        ...
        v_ERROR_MESSAGE_DATE || v_ERROR_MESSAGE_STR || v_ERROR_MESSAGE_NUM as o_COMBINED_ERROR_MESSAGE,
        case when v_VALIDATION_PASS_FAIL = 'F' then 1 else 0 end as o_ERROR_SEVERITY
    from DSR_EXP_LDSA_VALIDATION_CHECKER_FINANICAL_ACCOUNTOut
    left join (
        select ACTIVE_Y_N_STR_VL, STRING_VALUE2
        from (
            select ACTIVE_Y_N_STR_VL, STRING_VALUE2,
...
EXP_LDSA_VALIDATION_CHECKER_TMFOut as (
    select
        ...
        v_ERROR_MESSAGE_DATE || v_ERROR_MESSAGE_STR || v_ERROR_MESSAGE_NUM as o_COMBINED_ERROR_MESSAGE,
        case when v_VALIDATION_PASS_FAIL = 'F' then 1 else 0 end as o_ERROR_SEVERITY
    from DSR_EXP_LDSA_VALIDATION_CHECKER_TMFOut
    left join (
        select ACTIVE_Y_N_STR_VL, STRING_VALUE2
        from (
            select ACTIVE_Y_N_STR_VL, STRING_VALUE2,
...
EXP_LDSA_VALIDATION_CHECKER_MARGIN_ACCOUNTOut as (
    select
        ...
        v_ERROR_MESSAGE_DATE || v_ERROR_MESSAGE_STR || v_ERROR_MESSAGE_NUM as o_COMBINED_ERROR_MESSAGE,
        case when v_VALIDATION_pass_FAIL = 'F' then 1 else 0 end as o_ERROR_SEVERITY
    from DSR_EXP_LDSA_VALIDATION_CHECKER_MARGIN_ACCOUNTOut
    left join (
        select ACTIVE_Y_N_STR_VL, STRING_VALUE2
        from (
            select ACTIVE_Y_N_STR_VL, STRING_VALUE2,
...
EXP_LDSA_VALIDATION_CHECKER_PRODUCT_FAMILYOut as (
    select
        ...
        v_ERROR_MESSAGE_DATE || v_ERROR_MESSAGE_STR || v_ERROR_MESSAGE_NUM as o_COMBINED_ERROR_MESSAGE,
        case when v_VALIDATION_pass_FAIL = 'F' then 1 else 0 end as o_ERROR_SEVERITY
    from DSR_EXP_LDSA_VALIDATION_CHECKER_PRODUCT_FAMILYOut
    left join (
        select ACTIVE_Y_N_STR_VL, STRING_VALUE2
        from (
            select ACTIVE_Y_N_STR_VL, STRING_VALUE2,
...
EXP_LDSA_VALIDATION_CHECKER_POSITION_ACCOUNTOut as (
    select
        ...
        v_ERROR_MESSAGE_DATE || v_ERROR_MESSAGE_STR || v_ERROR_MESSAGE_NUM as o_COMBINED_ERROR_MESSAGE,
        case when v_VALIDATION_pass_FAIL = 'F' then 1 else 0 end as o_ERROR_SEVERITY
    from DSR_EXP_LDSA_VALIDATION_CHECKER_POSITION_ACCOUNTOut
    left join (
        select ACTIVE_Y_N_STR_VL, STRING_VALUE2
        from (
            select ACTIVE_Y_N_STR_VL, STRING_VALUE2,
...
EXP_LDSA_VALIDATION_CHECKER_ENTITYIDOut as (
    select
        ...
        v_ERROR_MESSAGE_DATE || v_ERROR_MESSAGE_STR || v_ERROR_MESSAGE_NUM as o_COMBINED_ERROR_MESSAGE,
        case when v_VALIDATION_pass_FAIL = 'F' then 1 else 0 end as o_ERROR_SEVERITY
    from DSR_EXP_LDSA_VALIDATION_CHECKER_ENTITYIDOut
    left join (
        select ACTIVE_Y_N_STR_VL, STRING_VALUE2
        from (
            select ACTIVE_Y_N_STR_VL, STRING_VALUE2,
...
EXP_LDSA_VALIDATION_CHECKER_TMF_master as (
    ...
    from EXP_LDSA_VALIDATION_CHECKER_TMFOut
),
...
EXP_LDSA_VALIDATION_CHECKER_COLLATERAL_ACCOUNT_details as (
    ...
    from EXP_LDSA_VALIDATION_CHECKER_COLLATERAL_ACCOUNTOut
),
...
EXP_LDSA_VALIDATION_CHECKER_MARGIN_ACCOUNT_details as (
    ...
    from EXP_LDSA_VALIDATION_CHECKER_MARGIN_ACCOUNTOut
),
...
EXP_LDSA_VALIDATION_CHECKER_CMF_details as (
    ...
    from EXP_LDSA_VALIDATION_CHECKER_CMFOut
),
...
EXP_LDSA_VALIDATION_CHECKER_PRODUCT_FAMILY_details as (
    ...
    from EXP_LDSA_VALIDATION_CHECKER_PRODUCT_FAMILYOut
),
...
EXP_PASS_THROUGH_details as (
    select
        ...
        EXP_PASS_THROUGHOut.FINANCIAL_ACCOUNT as FINANICAL_ACCOUNT,
...
EXP_LDSA_VALIDATION_CHECKER_POSITION_ACCOUNT_details as (
    ...
    from EXP_LDSA_VALIDATION_CHECKER_POSITION_ACCOUNTOut
),
...
EXP_LDSA_VALIDATION_CHECKER_SEGREGATION_TYPE_details as (
    ...
    from EXP_LDSA_VALIDATION_CHECKER_SEGREGATION_TYPEOut
),
...
EXP_LDSA_VALIDATION_CHECKER_ENTITYID_details as (
    ...
    from EXP_LDSA_VALIDATION_CHECKER_ENTITYIDOut
),
...
EXP_LDSA_VALIDATION_CHECKER_FINANICAL_ACCOUNT_details as (
    ...
    from EXP_LDSA_VALIDATION_CHECKER_FINANICAL_ACCOUNTOut
),
...
dsJoiner_EXP_CONSOLIDATE_VALIDATIONS0Out as (
    ...
    inner join EXP_LDSA_VALIDATION_CHECKER_TMF_master on EXP_LDSA_VALIDATION_CHECKER_TMF_master.jkey = EXP_PASS_THROUGH_details.jkey
    inner join EXP_LDSA_VALIDATION_CHECKER_COLLATERAL_ACCOUNT_details on EXP_LDSA_VALIDATION_CHECKER_TMF_master.jkey = EXP_LDSA_VALIDATION_CHECKER_COLLATERAL_ACCOUNT_details.jkey
    inner join EXP_LDSA_VALIDATION_CHECKER_MARGIN_ACCOUNT_details on EXP_LDSA_VALIDATION_CHECKER_TMF_master.jkey = EXP_LDSA_VALIDATION_CHECKER_MARGIN_ACCOUNT_details.jkey
    inner join EXP_LDSA_VALIDATION_CHECKER_CMF_details on EXP_LDSA_VALIDATION_CHECKER_TMF_master.jkey = EXP_LDSA_VALIDATION_CHECKER_CMF_details.jkey
    inner join EXP_LDSA_VALIDATION_CHECKER_PRODUCT_FAMILY_details on EXP_LDSA_VALIDATION_CHECKER_TMF_master.jkey = EXP_LDSA_VALIDATION_CHECKER_PRODUCT_FAMILY_details.jkey
    inner join EXP_PASS_THROUGH_details on EXP_LDSA_VALIDATION_CHECKER_TMF_master.jkey = EXP_PASS_THROUGH_details.jkey
    inner join SC_EXP_EPOC_GENERATOROut on EXP_LDSA_VALIDATION_CHECKER_TMF_master.jkey = SC_EXP_EPOC_GENERATOROut.jkey
    inner join EXP_LDSA_VALIDATION_CHECKER_POSITION_ACCOUNT_details on EXP_LDSA_VALIDATION_CHECKER_TMF_master.jkey = EXP_LDSA_VALIDATION_CHECKER_POSITION_ACCOUNT_details.jkey
    inner join EXP_LDSA_VALIDATION_CHECKER_SEGREGATION_TYPE_details on EXP_LDSA_VALIDATION_CHECKER_TMF_master.jkey = EXP_LDSA_VALIDATION_CHECKER_SEGREGATION_TYPE_details.jkey
    inner join EXP_LDSA_VALIDATION_CHECKER_ENTITYID_details on EXP_LDSA_VALIDATION_CHECKER_TMF_master.jkey = EXP_LDSA_VALIDATION_CHECKER_ENTITYID_details.jkey
    inner join EXP_LDSA_VALIDATION_CHECKER_FINANICAL_ACCOUNT_details on EXP_LDSA_VALIDATION_CHECKER_TMF_master.jkey = EXP_LDSA_VALIDATION_CHECKER_FINANICAL_ACCOUNT_details.jkey
),
...
EXP_CONSOLIDATE_VALIDATIONSOut as (
    select
        ...
        case when ENTITY_ID_VALIDATION_PASS_FAIL = 'F' or TMF_CODE_VALIDATION_PASS_FAIL = 'F' or CMF_CODE_VALIDATION_PASS_FAIL = 'F' or FINANCIAL_ACCOUNT_VALIDATION_PASS_FAIL = 'F' or COLLATERAL_ACCOUNT_VALIDATION_PASS_FAIL = 'F' or MARGIN_ACCOUNT_VALIDATION_PASS_FAIL = 'F' or POSITION_ACCOUNT_VALIDATION_PASS_FAIL = 'F' or SEGREGATION_TYPE_VALIDATION_PASS_FAIL = 'F' or PRODUCT_FAMILY_VALIDATION_PASS_FAIL = 'F' then 1 else 0 end as MD_ERROR_IND,
        ID as ID,
...
EXP_PASS_THROUGH_master as (
    ...
    ) dsf_1 on dsf_1.BATCH_ID = '{{ var("BATCH_ID") }}'
               and dsf_1.TARGET_TABLE_NAME = '{{ var("TARGET_NAME") }}'
               and dsf_1.FILE_NAME = '{{ var("FILE_NAME_OVERRIDE") }}'
    left join (
        select DIMENSION_KEY, NAME, EFFECTIVE_DATE, EXPIRATION_DATE
    ...
    ) dsf_2 on dsf_2.NAME = ENTITY_NAME
               and dsf_2.EFFECTIVE_DATE <= REPORT_DATE
               and dsf_2.EXPIRATION_DATE >= REPORT_DATE
),

dsJoiner_SC_LD_SA_TRADE_ACCOUNT0Out as (
    select
        SC_EXP_EPOC_GENERATOROut.ID as ID,
        ...
        EXP_PASS_THROUGH_master.TMF_CODE as TMF_CODE,
        EXP_PASS_THROUGH_master.CMF_CODE as CMF_CODE,
        EXP_PASS_THROUGH_master.FINANCIAL_ACCOUNT as FINANCIAL_ACCOUNT,
        EXP_PASS_THROUGH_master.COLLATERAL_ACCOUNT as COLLATERAL_ACCOUNT,
        EXP_PASS_THROUGH_master.MARGIN_ACCOUNT as MARGIN_ACCOUNT,
        EXP_PASS_THROUGH_master.POSITION_ACCOUNT as POSITION_ACCOUNT,
        EXP_PASS_THROUGH_master.SEGREGATION_TYPE as SEGREGATION_TYPE,
        EXP_PASS_THROUGH_master.PRODUCT_FAMILY as PRODUCT_FAMILY,
    ...
    inner join SC_EXP_EPOC_GENERATOROut on EXP_PASS_THROUGH_master.jkey = SC_EXP_EPOC_GENERATOROut.jkey
    inner join EXP_CONSOLIDATE_VALIDATIONSOut on EXP_PASS_THROUGH_master.jkey = EXP_CONSOLIDATE_VALIDATIONSOut.jkey
)
...
from dsJoiner_SC_LD_SA_TRADE_ACCOUNT0Out