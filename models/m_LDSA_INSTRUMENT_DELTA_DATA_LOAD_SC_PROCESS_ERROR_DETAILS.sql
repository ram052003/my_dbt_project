...
DSR_EXPTRANSOut AS (
    ...
    FROM SC_SEQ_LD_SA_INSTRUMENT_DELTAOut
),
...
dsJoiner_EXP_PASS_THROUGH0Out AS (
    ...
    INNER JOIN EXP_TRIM_details
        ON EXP_TRIM_details.jkey = EXPTRANSOut.jkey
),
...
dsJoiner_EXP_CONSOLIDATE_VALIDATIONS0Out AS (
    ...
    INNER JOIN EXP_PASS_THROUGHOut4
        ON EXP_LDSA_VALIDATION_CHECKER_DELTA_master.jkey = EXP_PASS_THROUGHOut4.jkey
...
EXP_CONSOLIDATE_VALIDATIONSOut1 AS (
    /* transType: "Expression" */
    SELECT
        ID,
        BATCH_ID,
...
DSR_FILTRANSOut AS (
    /* transType: "Expression" */
    SELECT
        EXP_CONSOLIDATE_VALIDATIONSOut1.O_ENTITY_ID_ERROR_MESSAGE AS ENTITY_ID_ERROR_MESSAGE,
        EXP_CONSOLIDATE_VALIDATIONSOut1.ISIN_CODE_ATTRIBUTE_NAME,
        EXP_CONSOLIDATE_VALIDATIONSOut1.ISIN_CODE_ERROR_SEVERITY,
        EXP_CONSOLIDATE_VALIDATIONSOut1.O_ISIN_CODE_ERROR_MESSAGE AS ISIN_CODE_ERROR_MESSAGE,
        EXP_CONSOLIDATE_VALIDATIONSOut1.DELTA_ATTRIBUTE_NAME,
        EXP_CONSOLIDATE_VALIDATIONSOut1.DELTA_ERROR_SEVERITY,
        EXP_CONSOLIDATE_VALIDATIONSOut1.O_DELTA_ERROR_MESSAGE AS DELTA_ERROR_MESSAGE,
        EXP_CONSOLIDATE_VALIDATIONSOut1.MD_ERROR_IND,
        EXP_CONSOLIDATE_VALIDATIONSOut1.ID,
        EXP_CONSOLIDATE_VALIDATIONSOut1.BATCH_ID,
        EXP_CONSOLIDATE_VALIDATIONSOut1.BATCH_DETAILS_ID,
        EXP_CONSOLIDATE_VALIDATIONSOut1.BATCH_START_DATE,
        EXP_CONSOLIDATE_VALIDATIONSOut1.BUSINESS_DATE,
        EXP_CONSOLIDATE_VALIDATIONSOut1.WORKFLOW_NAME,
        EXP_CONSOLIDATE_VALIDATIONSOut1.MAPPING_NAME,
        EXP_CONSOLIDATE_VALIDATIONSOut1.TARGET_NAME,
        EXP_CONSOLIDATE_VALIDATIONSOut1.VALIDATION_NAME,
        EXP_CONSOLIDATE_VALIDATIONSOut1.ENTITY_ID_ATTRIBUTE_NAME,
        EXP_CONSOLIDATE_VALIDATIONSOut1.ENTITY_ID_ERROR_SEVERITY
...
SC_mplt_DV_PROCESS_ERROR_DETAILSOut AS (
    ...
    SELECT
        ...
        ISIN_CODE_ATTRIBUTE_NAME AS INPUT_ATTRIBUTE_NAME_2,
        ISIN_CODE_ERROR_SEVERITY AS INPUT_ERROR_SEVERITY_2,
        ISIN_CODE_ERROR_MESSAGE AS INPUT_ATTRIBUTE_VALUE_2,
        DELTA_ATTRIBUTE_NAME AS INPUT_ATTRIBUTE_NAME_3,
        DELTA_ERROR_SEVERITY AS INPUT_ERROR_SEVERITY_3,
        DELTA_ERROR_MESSAGE AS INPUT_ATTRIBUTE_VALUE_3,
